...
*/
const $ = new Env('东东农场');
let cookiesArr = [], cookie = 'pt_key=AAJfwKteADAzp6Wv3ZYCujTOgUoYOvZix9dt28fDMweSRrOOUG2VtJDLLwNb5K4ujsYku0Lsnpc; pt_pin=ryosaebat; pt_token=9yxgofz0; pwdt_id=ryosaebat;', jdFruitShareArr = [], isBox = false, notify, newShareCodes;
