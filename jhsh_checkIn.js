...
[Script]
建行数据 = type=http-request,pattern=^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|A3341A188|autoLogin),requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/FoKit/Scripts/main/scripts/jhsh_checkIn.js
...
[Script]
http-request ^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|A3341A188|autoLogin) tag=建行数据, script-path=https://raw.githubusercontent.com/johnwick-xyz/loon/main/jhsh_checkIn.js,requires-body=1
...
[rewrite_local]
^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|A3341A188|autoLogin) url script-request-body https://raw.githubusercontent.com/johnwick-xyz/loon/main/jhsh_checkIn.js
...
http:
  mitm:
    - "yunbusiness.ccb.com"
  script:
    - match: ^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|A3341A188|autoLogin)
      name: 建行生活
      type: request
      require-body: true
...
function GetCookie() {
  ...
  if (/A3341A038|A3341A188/.test($request.url)) {
