...
[Script]
建行数据 = type=http-request,pattern=^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|A3341C128|A3341A195|autoLogin),requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/FoKit/Scripts/main/scripts/jhsh_checkIn.js

建行生活 = type=cron,cronexp=17 7 * * *,timeout=60,script-path=https://raw.githubusercontent.com/johnwick-xyz/loon/main/jhsh_checkIn.js,script-update-interval=0
...
[Script]
http-request ^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|A3341C128|A3341A195|autoLogin) tag=建行数据, script-path=https://raw.githubusercontent.com/johnwick-xyz/loon/main/jhsh_checkIn.js,requires-body=1
...
[rewrite_local]
^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|A3341C128|autoLogin) url script-request-body https://raw.githubusercontent.com/johnwick-xyz/loon/main/jhsh_checkIn.js
...
http:
  mitm:
    - "yunbusiness.ccb.com"
  script:
    - match: ^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341C128|autoLogin)
      name: 建行生活
      type: request
      require-body: true
...
script-providers:
  建行生活:
    url: https://raw.githubusercontent.com/johnwick-xyz/loon/main/jhsh_checkIn.js
    interval: 86400
...
function GetCookie() {
  ...
  if (/A3341A038|A3341C128|A3341A195/.test($request.url)) {
